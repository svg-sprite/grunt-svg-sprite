## 1.3.7 Compatibility release (unreleased)
...
* Updated dependencies
* Made Grunt a peer dependency and allowed Grunt 1.x ([#70](https://github.com/jkphl/grunt-svg-sprite/pull/70))
* Updated documentation ([#69](https://github.com/jkphl/grunt-svg-sprite/issues/69))
...
* Fixed broken svg4everybody links ([svg-sprite #122](https://github.com/jkphl/svg-sprite/issues/122), [gulp-svg-sprite #39](https://github.com/jkphl/gulp-svg-sprite/issues/39))

## 1.2.13 Maintenance release (2015-11-06)
* Compatible with [svg-sprite 1.2.13](https://github.com/jkphl/svg-sprite/tree/v1.2.13)
* Support for source files outside the cwd ([#62](https://github.com/jkphl/grunt-svg-sprite/issues/62))
...
* Improved error handling & display ([#58](https://github.com/jkphl/grunt-svg-sprite/issues/58))
